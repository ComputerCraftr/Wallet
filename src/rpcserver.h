...
/**
 * BeetleCoin RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue setzbeetseed(const UniValue& params, bool fHelp);
extern UniValue getzbeetseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzbeet(const UniValue& params, bool fHelp);
extern UniValue dzbeetstate(const UniValue& params, bool fHelp);
